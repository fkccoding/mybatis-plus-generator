package com.chuckfang.mybatisplusgenerator.util;
 ...
 * @date Created on 2020/7/22 11:57
 */
public class CodeGenerator {
    ...
    public void code(String... tableNames) {
        codingMysql(false, true, true, this.dbUrl, this.userName, this.password, this.dir, this.xmlDir, this.packageName, tableNames);
    }
